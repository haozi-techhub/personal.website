...
| **当前 HEAD** | Yink 项目卡片上线、Photos 去除浮动按钮、部署配置修复 |
...
**结构：5 屏全页 snap 滚动（scroll-snap）**

| 屏 | ID | 内容 |
|---|---|---|
| 屏 1 | `#hero` | 大字 Hello! + 个人头像 + 自我介绍 block |
...
| 未来 | 留言 / Guestbook（已有设计文档 `09-guestbook.md`，代码已删除待重启） |
